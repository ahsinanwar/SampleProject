    ...
    public partial class DLateIn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewLateComers.Where(aa => aa.AttDate == dt && aa.StatusLI == true).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewLateComer> _ViewList = new List<ViewLateComer>();
            List<ViewLateComer> _TempViewList = new List<ViewLateComer>();
            _ViewList = context.ViewLateComers.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date && aa.StatusLI == true).ToList();
        ...
        private void LoadReport(string path, List<ViewLateComer> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Late In Report";
