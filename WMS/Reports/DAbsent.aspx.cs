    ...
    public partial class DAbsent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewAbsents.Where(aa => aa.AttDate == dt && aa.StatusAB == true).ToList());
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewAbsent> _ViewList = new List<ViewAbsent>();
            List<ViewAbsent> _TempViewList = new List<ViewAbsent>();
            _ViewList = context.ViewAbsents.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date && aa.StatusAB == true).ToList();
        ...
        private void LoadReport(string path, List<ViewAbsent> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Absent Employee Report";
