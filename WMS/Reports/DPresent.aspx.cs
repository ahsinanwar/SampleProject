    ...
    public partial class Dpresent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewPresentEmps.Where(aa => aa.AttDate == dt && aa.StatusP == true).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            _ViewList = context.ViewPresentEmps.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date && aa.StatusP == true).ToList();
        ...
        private void LoadReport(string path, List<ViewPresentEmp> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Present Report";
