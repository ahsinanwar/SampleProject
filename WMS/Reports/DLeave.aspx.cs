    ...
    public partial class DLeave : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                RefreshLabels();
                DateTime dt = DateTime.Today.Date.AddDays(-5);
                ...
                LoadReport(PathString, context.ViewLeaveDatas.Where(aa => aa.LvDate == dt).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewLeaveData> _ViewList = new List<ViewLeaveData>();
            List<ViewLeaveData> _TempViewList = new List<ViewLeaveData>();
            _ViewList = context.ViewLeaveDatas.Where(aa => aa.LvDate >= DateFrom.Date && aa.LvDate <= DateTo.Date).ToList();
        ...
        private void LoadReport(string path, List<ViewLeaveData> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Leaves Report";
