    ...
    public partial class DOverTime : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dt = qb.GetValuesfromDB("select * from ViewOverTime " + query + " and AttDate = '" + date.Date.Year.ToString() + "-" + date.Date.Month.ToString() + "-" + date.Date.Day.ToString() + "'" + " and StatusOT=1 ");
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = qb.GetValuesfromDB("select * from ViewOverTime " + query + " and (AttDate >= " + _dateFrom + " and AttDate <= " + _dateTo + " )" + " and StatusOT=1 " + "and StatusGZOT = 1 ");
        ...
        private void LoadReport(string path, List<ViewOverTime> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Overtime Report";
