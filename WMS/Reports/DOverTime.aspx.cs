    ...
    public partial class DOverTime : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewOverTimes.Where(aa => aa.AttDate == dt && aa.StatusOT == true || aa.StatusGZOT == true).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewOverTime> _ViewList = new List<ViewOverTime>();
