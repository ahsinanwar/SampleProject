    ...
    public partial class EmpAttSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewSummaries.Where(aa => aa.AttDate >= dt && aa.EmpID == 1).ToList());
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewSummary> _ViewList = new List<ViewSummary>();
            List<ViewSummary> _TempViewList = new List<ViewSummary>();
            _ViewList = context.ViewSummaries.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date).ToList();
        ...
        private void LoadReport(string path, List<ViewSummary> _Employee)
        {
            string DateToFor = "";
