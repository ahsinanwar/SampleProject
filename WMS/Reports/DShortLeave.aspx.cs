    ...
    public partial class DShortLeave : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                RefreshLabels();
                DateTime dt = DateTime.Today.Date.AddDays(-10);
                ...
                LoadReport(PathString, context.ViewSLDatas.Where(aa => aa.DutyDate >= dt).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewSLData> _ViewList = new List<ViewSLData>();
            List<ViewSLData> _TempViewList = new List<ViewSLData>();
            _ViewList = context.ViewSLDatas.Where(aa => aa.DutyDate >= DateFrom.Date && aa.DutyDate <= DateTo.Date).ToList();
