    ...
    public partial class DLateOut : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewLateOuts.Where(aa => aa.AttDate == dt && aa.StatusLO == true).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DivTypeGrid.Visible = false;
            ReportViewer1.Visible = true;
            List<ViewLateOut> _ViewList = new List<ViewLateOut>();
            List<ViewLateOut> _TempViewList = new List<ViewLateOut>();
            _ViewList = context.ViewLateOuts.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date && aa.StatusLO == true).ToList();
        ...
        private void LoadReport(string path, List<ViewLateOut> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Late Out Report";
