    ...
    public partial class DMultipleInOut : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                LoadReport(PathString, context.ViewMultipleInOuts.Where(aa => aa.AttDate == dt && aa.StatusP == true).ToList());
            }
        }
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            _ViewList = context.ViewMultipleInOuts.Where(aa => aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date && aa.StatusP == true).ToList();
        ...
        private void LoadReport(string path, List<ViewMultipleInOut> _Employee)
        {
            ...
            string _Header = context.Options.FirstOrDefault().CompanyName + " - Detailed Multiple In/Out";
